...
<script type="text/javascript">
	function add() {
	    ...
	    form.attr('action', "cm_online_petition_add");
	...
	function importFuc() {
	    ...
	    form.attr('target', '');
	    form.attr('method', 'post');
	    form.attr('action', "cm_online_petition_import_show");
	...
	function look(id) {
	    ...
	    form.attr('target', '');
	    form.attr('method', 'post');
	    form.attr('action', "cm_online_petition_look");
	...
	function edit(id) {
	    ...
	    form.attr('target', '');
	    form.attr('method', 'post');
	    form.attr('action', "cm_online_petition_edit");
...
//         }
	...
	function imageRecognition(id) {
	    ...
	    form.attr('target', '');
	    form.attr('method', 'post');
	    form.attr('action', "cm_online_petition_image_list");
            ...
            <div class="pubilc_right_cn">
                <div class="cfcx">
                    <div class="cfcx_2">
                        ...
                        <form id="searchForm" action="cm_online_petition_list" method="post">
		                    <div class="select_eg">
