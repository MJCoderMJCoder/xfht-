					  ...
					  <tr>
						 ...
						 <tr>
								...
								<tr>
									...
									<td colspan="2"><input class="input_color" id="processingCompany" name="processingCompany" type="text" value="${g.ext.processingCompany.name }" readonly="readonly"/></td>
									<td class="table_grey" ><span>*</span>案件负责人：</td>
									<td colspan="2"><input class="input_color" id="processingHead" name="processingHead" type="text" value="${g.ext.processingHead.description }" readonly="readonly"/></td>
								</tr>
