...
function save(){
	...
	$.ajax({
        type: "POST",
        dataType: 'json',
        url: "cm_user_saveEdit",
        data: $("#editForm").serialize(),
        traditional: true,
        success: function(data){
        	if(data.status==0) {
        		$("#sucessNotice").text("修改密码成功！");
...
<div class="center">
	...
	<div class="pubilc_right fl">
    	<div class="pubilc_right_cn">
      		<div class="cfcx">
      	  		<div class="cfcx_2">
      	  	   		<h1 class="kzt_bt"><span>修改密码</span></h1>
      	  	   	  	<div class="table_eg">
      	  	   	  		<form action="cm_user_saveEdit" id="editForm" name="editForm" method="post">
				  		<table width="60%" border="0" cellspacing="0" cellpadding="0" class="table_one">
							<tbody>
					  		<tr>
								<td width="20%" class="table_grey"><span>*</span>原密码：</td>
								<td width="30%" colspan="2"><input class="input_color" id="password" name="password" type="password"/></td>
					  		</tr>
					  		<tr>
