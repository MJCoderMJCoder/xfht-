...
<div class="pubilc_right fl">
      <div class="pubilc_right_cn">
      	  ...
      	  <form action="cm_incomingLetter_update" id="editForm" name="editForm" method="post">
      	  <div class="cfcx">
      	  	   <div class="cfcx_2">
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_one">
					<tbody>
					  <tr>
						...
						<td width="30%" colspan="2"><input class="input_color" id="informantName" name="informantName" type="text" maxlength="10" value="${g.ext.informantName }"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantAge" name="informantAge" type="text" value="${g.ext.informantAge }" maxlength="2" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantCardNo" name="informantCardNo" type="text" value="${g.ext.informantCardNo }" maxlength="18"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantPlace" name="informantPlace" type="text" value="${g.ext.informantPlace }" maxlength="50"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantPhone" name="informantPhone" type="text" value="${g.ext.informantPhone }" maxlength="11"/></td>
					  	<td class="table_grey" >发信时间：</td>
						<td colspan="2">
							<input onclick="SetDate(this,'yyyy-MM-dd hh:mm:ss')" placeholder="选择发信时间" class="select_time input_color" id="letterTime" name="letterTime" value="<fmt:formatDate value="${g.ext.letterTime}"  pattern="yyyy-MM-dd hh:mm:ss"/>"/>
						</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="peopleCount" name="peopleCount" type="text" value="${g.peopleCount }" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
					  </tr>
					  <tr>
						<td class="table_grey" >来信代表：</td>
						<td colspan="2"><input class="input_color" id="leader" name="leader" type="text" value="${g.leader }" maxlength="10"/></td>
						<td class="table_grey" >异常行为：</td>
						<td colspan="2"><input class="input_color" id="abnormalBehavior" name="abnormalBehavior" value="${g.ext.abnormalBehavior }" type="text" maxlength="50"/></td>
					  </tr>
					  <tr>
						 ...
						 <tr>
								...
								<tr>
									...
									<td colspan="2"><input type="radio" id="repeatLetter" name="repeatLetter" value="1" class="sex" <c:if test="${g.ext.repeatLetter==true}">checked </c:if>> 是 <input type="radio" id="repeatLetter" name="repeatLetter" value="0" class="sex" <c:if test="${g.ext.repeatLetter==false}">checked </c:if>>否</td>
