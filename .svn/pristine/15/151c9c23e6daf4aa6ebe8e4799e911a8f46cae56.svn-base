								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_one">
									<tbody>
										<tr>
											...
											<td width="30%" colspan="2"><input class="input_color" id="assignNumber" name="assignNumber" value="${guestbook.ext.assignNumber}" type="text" placeholder="请输入交办号 " maxlength="50" /></td>
											<td width="20%" class="table_grey"><span>*</span>交办人：</td>
											<td width="30%" colspan="2"><input class="input_color" id="assignPerson" name="assignPerson" value="${guestbook.ext.assignPerson}" type="text" placeholder="请输入交办人 " maxlength="50" /></td>
										</tr>
										<tr>
											<td width="20%" class="table_grey"><span>*</span>交办人职务：</td>
											<td width="30%" colspan="2"><input class="input_color" id="assignPersonPost" name="assignPersonPost" value="${guestbook.ext.assignPersonPost}" type="text" placeholder="请输入交办人职务 " maxlength="50" /></td>
											<td width="20%" class="table_grey"><span>*</span>交办人单位：</td>
											<td width="30%" colspan="2"><input class="input_color" id="assignCompany" name="assignCompany" value="${guestbook.ext.assignCompany}" type="text" placeholder="请输入交办人单位 " maxlength="50" /></td>
										</tr>
										<tr>
											...
											<td colspan="2">
												<select id="assignModality" name="assignModality">
													...
													<c:forEach items="${assignModalityList }" var="obj" varStatus="status">
														<option value="${obj.name }" ${guestbook.ext.assignModality==obj.name?'selected':''}>${obj.name }</option>
													</c:forEach>
												</select>
											</td>
											<td width="20%" class="table_grey">保管人：</td>
											<td width="30%" colspan="2"><input class="input_color" id="preserver" name="preserver" value="${guestbook.ext.preserver}" type="text" placeholder="请输入保管人" maxlength="50" /></td>
										</tr>
										<tr>
											<td width="20%" class="table_grey">地点：</td>
											<td width="30%" colspan="5"><input class="input_color" id="place" name="place" value="${guestbook.ext.place}" type="text" placeholder="请输入地点" maxlength="200" /></td>
										</tr>
									</tbody>
								</table>
							</div>
									...
									<tbody>
										<tr>
											...
											<td width="30%" colspan="2">
												<input class="input_color" id="complaintNumber" name="complaintNumber" value="${guestbook.complaintNumber}" type="text" placeholder="请输入信访编号" maxlength="50" />
											</td>
											<td width="20%" class="table_grey"><span>*</span>创建日期：</td>
											<td width="30%" colspan="2">
												<input onclick="SetDate(this,'yyyy-MM-dd hh:mm:ss')" placeholder="请输入创建日期" class="select_time" id="createTime" name="createTime"  value="${guestbook.createTime}"/>
											</td>
										</tr>
										<tr>
											...
											<td colspan="2">
												<select id="informantSex" name="informantSex">
													...
													<c:forEach items="${genderList }" var="obj" varStatus="status">
														<option value="${obj.value }" ${guestbook.ext.informantSex==obj.value?'selected':''}>${obj.name }</option>
													</c:forEach>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td colspan="2">
												<input class="input_color" id="informantAge" name="informantAge" value="${guestbook.ext.informantAge}" type="text" placeholder="请输入年龄" maxlength="2" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" />
											</td>
											...
											<td colspan="2">
												<select id="informantNation" name="informantNation">
													...
													<c:forEach items="${nationList }" var="obj" varStatus="status">
														<option value="${obj.name }" ${guestbook.ext.informantNation==obj.name?'selected':''}>${obj.name }</option>
													</c:forEach>
												</select>
											</td>
										</tr>
											...
											<td colspan="2">
												<select id="informantEducation" name="informantEducation">
													...
													<c:forEach items="${educationList }" var="obj" varStatus="status">
														<option value="${obj.name }" ${guestbook.ext.informantEducation==obj.name?'selected':''}>${obj.name }</option>
													</c:forEach>
												</select>
											</td>
										</tr>
											...
											<td colspan="2">
												<select id="matterProperty" name="matterProperty">
													...
													<c:forEach items="${matterPropertyList }" var="obj" varStatus="status">
														<option value="${obj.name }" ${guestbook.ext.matterProperty==obj.name?'selected':''}>${obj.name }</option>
													</c:forEach>
												</select>
											</td>
											...
											<td colspan="2">
												<select id="informantGrade" name="informantGrade">
													...
													<c:forEach items="${informantGradeList }" var="obj" varStatus="status">
														<option value="${obj.name }" ${guestbook.ext.informantGrade==obj.name?'selected':''}>${obj.name }</option>
													</c:forEach>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td colspan="2">
												<input class="input_color" id="peopleCount" name="peopleCount" value="${guestbook.peopleCount}" type="text" placeholder="请输入来访人数" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" />
											</td>
											<td class="table_grey">来访代表：</td>
											<td colspan="2">
												<input class="input_color" id="leader" name="leader" value="${guestbook.leader}" type="text" placeholder="请输入来访代表" maxlength="10" />
											</td>
										</tr>
										<tr>
