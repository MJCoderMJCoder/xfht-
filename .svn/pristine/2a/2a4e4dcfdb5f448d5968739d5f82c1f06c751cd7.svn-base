...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
	...
	this.colors = {
		...
		"sun_word" : "#6b95e4", // 星期天文字颜色
		"sat_word" : "#6b95e4", // 星期六文字颜色
		"td_word_light" : "#666", // 单元格文字颜色
		"td_word_dark" : "#ccc", // 单元格文字暗色
		"td_bg_out" : "#fff", // 单元格背影色
		"td_bg_over" : "#FFCC00", // 单元格背影色
		"tr_word" : "#fff", // 日历头文字颜色
		"tr_bg" : "#628ac5", // 日历头背影色
		"input_border" : "#6b95e4", // input控件的边框颜色
		"input_bg" : "#6b95e4", // input控件的背影色
		"input_txt" : "#fff", // input控件的文字色		
...
Calendar.prototype.draw = function() {
	...
	mvAry[mvAry.length] = '        <th align="left" width="1%"><input style="border: 1px solid '
			...
			+ ';color:'
			+ calendar.colors["input_txt"]
			+ ';width:16px;height:20px; padding:0;" name="prevMonth" type="button" id="prevMonth" value="<" /></th>';
	...
	mvAry[mvAry.length] = '        <th align="right" width="1%"><input style="border: 1px solid '
			...
			+ ';color:'
			+ calendar.colors["input_txt"]
			+ ';width:16px;height:20px; padding:0;" name="nextMonth" type="button" id="nextMonth" value=">" /></th>';
	mvAry[mvAry.length] = '      </tr>';
	mvAry[mvAry.length] = '    </table>';
	mvAry[mvAry.length] = '    <table id="calendarTable" width="100%" style="border:0px;background:#93b0d9" border="0" cellpadding="3" cellspacing="1">';
	mvAry[mvAry.length] = '      <tr>';
	for ( var i = 0; i < 7; i++) {
	...
	mvAry[mvAry.length] = '        <td colspan="6" style=" background:#fff;"><select name="calendarHour" id="calendarHour"></select>';
	...
	mvAry[mvAry.length] = '      <tr  style="background:#fff;">';
	mvAry[mvAry.length] = '        <th colspan="7"><input name="calendarClear" type="button" id="calendarClear" value="'
			...
			+ ';color:'
			+ calendar.colors["input_txt"]
			+ ';width:26%;height:20px;font:12px/18px 微软雅黑;"/>  <input name="calendarToday" type="button" id="calendarToday" value="'
			...
			+ ';color:'
			+ calendar.colors["input_txt"]
			+ ';width:26%;height:20px;font:12px/18px 微软雅黑;"/>  <input name="calendarClose" type="button" id="calendarClose" value="'
			...
			+ ';color:'
			+ calendar.colors["input_txt"]
			+ ';width:26%;height:20px;font:12px/18px 微软雅黑;"/></th>';
	mvAry[mvAry.length] = '      </tr>';
	mvAry[mvAry.length] = '    </table>';
...
//document
//		.write('background: #fff;border: 1px solid #ccc;width:200px;font:12px/18px 微软雅黑;margin-left:25px;"></div>');
/**if (document.all) {
	document
