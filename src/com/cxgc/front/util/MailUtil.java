 ...
 * Description            :  发送邮件基础方法文件
 * @version  0.0.0.1
 */
public class MailUtil {
	
	protected final Logger log = Logger.getLogger(MailUtil.class);
...
//		String from = "18745171299@163.com";// 邮件显示名称
//		String to = "zhangyiyang003@163.com";// 收件人的邮件地址，必须是真实地址
//		String copyto = "";// 抄送人邮件地址
//		String subject = "测试邮件";// 邮件标题
//		String content = "你好！";// 邮件内容
//		String username = "18745171299@163.com";// 发件人真实的账户名
//		String password = "fzxlovewq";// 发件人密码
//		MailUtil.sendAndCc(smtp, from, to, copyto, subject, content, username, password);
		
		/*
		Field[] field = CxCourse.class.getDeclaredFields();
