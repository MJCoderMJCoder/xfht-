									...
									<tbody>
										<tr>
											...
											<td width="30%" colspan="2">
												<input class="input_color" id="complaintNumber" name="complaintNumber" type="text" placeholder="请输入信访编号" maxlength="50" value="${complaintNumber}" readonly="readonly"/>
											</td>
											<td width="20%" class="table_grey">创建日期：</td>
											<td width="30%" colspan="2">
												<input class="input_color" id="createTime" name="createTime" type="text" placeholder="请输入创建日期" maxlength="50" value="${createTime}" readonly="readonly"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="2">
												<input class="input_color" id="title" name="title" type="text" placeholder="请输入标题" maxlength="50" />
											</td>
										...
										<tr>
											...
											<td colspan="2">
												<input class="input_color" id="matterDetailed" name="matterDetailed" type="text" placeholder="请输入问题细类" maxlength="50" />
											</td>
