...
$(document).ready(function(){
	...
	$(".close_btn1").click(function(){
		window.location.href="cm_incomingLetter_list"; 
	});
...
function save(){
	...
	var repeatLetter=$('input:radio[name="repeatLetter"]:checked').val();
	if(repeatLetter == null){
		$("#notice").html("是否为重复信件不能为空！");
		$(".jg_block").css("display","block");
		return false;
	}
	...
	$.ajax({
        type: "POST",
        dataType: 'json',
        url: "cm_incomingLetter_save",
        data: $("#addForm").serialize(),
        traditional: true,
        dataType: "json",
        success: function(data){
        	if(data.status==0) {
        		var complaintNumber=data.complaintNumber;
        		$("#sucessNotice").text("案件编号为 "+complaintNumber+",请您妥善保管");
...
<div class="pubilc_right fl">
      <div class="pubilc_right_cn">
      	  ...
      	  <form action="cm_incomingLetter_save" id="addForm" name="addForm" method="post">
      	  <div class="cfcx">
      	  	   <div class="cfcx_2">
      	  	   	  <h1 class="kzt_bt"><span>来信人员信息及反应情况</span></h1>
      	  	   	  <div class="table_eg">
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_one">
					<tbody>
					  <tr>
						<td width="20%" class="table_grey">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
						<td width="30%" colspan="2"><input class="input_color" id="informantName" name="informantName" type="text" maxlength="10"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantAge" name="informantAge" type="text" maxlength="2" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantCardNo" name="informantCardNo" type="text" maxlength="18"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantPlace" name="informantPlace" type="text" maxlength="50"/></td>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="informantPhone" name="informantPhone" type="text" maxlength="11"/></td>
					  	<td class="table_grey" >发信时间：</td>
						<td colspan="2">
							<input onclick="SetDate(this,'yyyy-MM-dd hh:mm:ss')" placeholder="选择发信时间" class="select_time input_color" id="letterTime" name="letterTime"/>
							<!-- <input class="input_color" id="abnormalBehavior" name="abnormalBehavior" type="text" placeholder="请输入异常行为" maxlength="50"/> -->
						</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<td colspan="2"><input class="input_color" id="peopleCount" name="peopleCount" type="text" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/></td>
					  </tr>
					  <tr>
						<td class="table_grey" >来信代表：</td>
						<td colspan="2"><input class="input_color" id="leader" name="leader" type="text" maxlength="10"/></td>
						<td class="table_grey" >异常行为：</td>
						<td colspan="2"><input class="input_color" id="abnormalBehavior" name="abnormalBehavior" type="text" maxlength="50"/></td>
					  </tr>
					  <tr>
						 ...
						 <tr>
								...
								<tr>
									<td width="20%" class="table_grey"><span>*</span>是否为重复信件：</td>
									
									<td colspan="2"><input type="radio" id="repeatLetter" name="repeatLetter" class="sex" value="1"> 是 <input type="radio" id="repeatLetter" name="repeatLetter" class="sex" value="0">否</td>
									<!-- <td colspan="2"><input type="radio" id="satisfied" name="satisfied" class="sex" value="1"> 满意 <input type="radio" id="satisfied" name="satisfied" class="sex" value="0">不满意</td> -->
									<td class="table_grey" ><span>*</span>接待人：</td>
									<td colspan="2"><input class="input_color" id="receptionist" name="receptionist" type="text" placeholder="请输入接待人" maxlength="10"/></td>
								</tr>
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_one">
						<tbody>
						  ...
						  <tr>
							...
							<td colspan="2"><input class="input_color" type="text" id="reportedCompany" name="reportedCompany" placeholder="请输入单位" maxlength="50"/></td>
                  ...
                  <div class="sj_bt">
                    ...
                    <input type="button" class="bt_small bt_yellow" value="返&nbsp;&nbsp;&nbsp;回" onclick="javascript:window.location.href='/cm_incomingLetter_list'"/>
                  </div>
                </div>
      	  </div>
		</form>
