...
function detailed(id){
    ...
    form.attr('action', "cm_incomingLetter_detailed");
...
function edit(id){
    ...
    form.attr('target', '');
    form.attr('method', 'post');
    form.attr('action', "cm_incomingLetter_edit");
...
function deleteBook(id){
	$.ajax({
        type: "POST",
        dataType: 'json',
        url: "cm_incomingLetter_updateBook",
        data: {"id":id,"status":0},
        traditional: true,
        dataType: "json",
...
function distinguish(id){
    ...
    form.attr('target', '');
    form.attr('method', 'post');
    form.attr('action', "cm_incomingLetter_picList");
      ...
      <div class="pubilc_right_cn">
        <div class="cfcx">
          <div class="cfcx_2">
            ...
            <div class="select_eg">
              <form action="cm_incomingLetter_list" id="searchForm" name="searchForm" method="post">
              ...
              <div class="select_btn">
                ...
                <input type="button" class="select_xz bt_small" value="新&nbsp;&nbsp;增" onclick="javascrtpt:window.location.href='/cm_incomingLetter_add'"/> 
